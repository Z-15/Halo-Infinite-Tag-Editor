	...
	public class TagLayouts
	{
		...
		public class run_parse
		{
			...
			public Dictionary<long, C?> parse_the_mfing_xmls(string file_to_find)
			{
				...
				string predicted_file = Directory.GetCurrentDirectory() + "\\Tag_Structures\\"+ file_to_find+".xml";
			...
			public long the_switch_statement(XmlNode xn, long offset, ref Dictionary<long, C?> pairs)
			{
				...
				{
					case "_0":
						pairs.Add(offset, new C { T = "String", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_1":
						pairs.Add(offset, new C { T = "String", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_2":
						pairs.Add(offset, new C { T = "mmr3Hash", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_3":// unmapped - This case isn't found in any tag file
						pairs.Add(offset, new C { T = "Comment", N = xn.Attributes.GetNamedItem("v").InnerText + " (unmapped type(" + xn.Name + "), may cause errors)", S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_4":
						pairs.Add(offset, new C { T = "Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_5":
						pairs.Add(offset, new C { T = "2Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_6":
						pairs.Add(offset, new C { T = "4Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_7":
						pairs.Add(offset, new C { T = "Pointer", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_8":
						pairs.Add(offset, new C { T = "Float", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_9": 
						pairs.Add(offset, new C { T = "String", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_A":
						...
						pairs.Add(offset, new EnumGroup { A = 1, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary1, S = group_lengths_dict[xn.Name] });
					...
					case "_B":
						...
						pairs.Add(offset, new EnumGroup { A = 2, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary2, S = group_lengths_dict[xn.Name] });
					...
					case "_C":
						...
						pairs.Add(offset, new EnumGroup { A = 4, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary3, S = group_lengths_dict[xn.Name] });
					...
					case "_D":
						...
						pairs.Add(offset, new FlagGroup { A = 4, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary4, S = group_lengths_dict[xn.Name] });
					...
					case "_E":
						...
						pairs.Add(offset, new FlagGroup { A = 2, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary5, S = group_lengths_dict[xn.Name] });
					...
					case "_F":
						...
						pairs.Add(offset, new FlagGroup { A = 1, N = xn.Attributes.GetNamedItem("v").InnerText, STR = childdictionary6, S = group_lengths_dict[xn.Name] });
					...
					case "_15":
						...
						return group_lengths_dict[xn.Name];
					case "_16":
						pairs.Add(offset, new C { T = "2DPoint_Float", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_17":
						pairs.Add(offset, new C { T = "3DPoint", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_18":
						pairs.Add(offset, new C { T = "2DPoint_Float", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_19":
						...
						return group_lengths_dict[xn.Name];
					case "_1A":
						pairs.Add(offset, new C { T = "Quanternion", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_1B":
						pairs.Add(offset, new C { T = "2DPoint_Float", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					...
					case "_1E": // pretty sure this is currect, could be wrong though. I referenced calculus equations
						pairs.Add(offset, new C { T = "3DPlane", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_1F":
						pairs.Add(offset, new C { T = "RGB", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_20":
						pairs.Add(offset, new C { T = "ARGB", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					...
					case "_22":// unmapped  - only found in ttag
						...
						return group_lengths_dict[xn.Name];
					case "_23":
						pairs.Add(offset, new C { T = "2Byte", N = xn.Attributes.GetNamedItem("v").InnerText + ".min", S = group_lengths_dict[xn.Name] });
						pairs.Add((offset + 2), new C { T = "2Byte", N = xn.Attributes.GetNamedItem("v").InnerText + ".max", S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_24":
						pairs.Add(offset, new C { T = "BoundsFloat", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					case "_25":
						pairs.Add(offset, new C { T = "BoundsFloat", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
						return group_lengths_dict[xn.Name];
					...
					case "_34": // field pad
						...
						if (length == 1)
						{
							pairs.Add(offset, new C { T = "Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = 1 });
						}
						else if (length == 2)
						{
							pairs.Add(offset, new C { T = "2Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = 2 });
						}
						else if (length == 4)
						{
							pairs.Add(offset, new C { T = "4Byte", N = xn.Attributes.GetNamedItem("v").InnerText, S = 4 });
						}
						else
						{
							pairs.Add(offset, new C { T = "Comment", N = xn.Attributes.GetNamedItem("v").InnerText, S = length });
						}
						return length;
					case "_35":
						pairs.Add(offset, new C { T = "4Byte", N = xn.Attributes.GetNamedItem("v").InnerText + " Index", S = 4 }); // Definitely could be wrong, just guessing here.
						pairs.Add(offset + 4, new C { T = "mmr3Hash", N = xn.Attributes.GetNamedItem("v").InnerText + " Name", S = 4 });
						return int.Parse(xn.Attributes.GetNamedItem("length").InnerText);
					case "_36":
						if (xn.Attributes.GetNamedItem("v").InnerText != "")
						{
							pairs.Add(offset + evalutated_index_PREVENT_DICTIONARYERROR, new C { T = "Comment", N = xn.Attributes.GetNamedItem("v").InnerText, S = group_lengths_dict[xn.Name] });
					...
					case "_3E":
						...
						return group_lengths_dict[xn.Name];
					case "_3F":
						pairs.Add(offset, new C { T = "Pointer", N = xn.Attributes.GetNamedItem("v").InnerText , S = 8});
						return group_lengths_dict[xn.Name];
					case "_40":
						...
						{
							pairs.Add(offset, new C { T = "Tagblock", N = xn.Attributes.GetNamedItem("v").InnerText, S = 20 });
						}
						return group_lengths_dict[xn.Name];
					case "_41":
						pairs.Add(offset, new C { T = "TagRef", N = xn.Attributes.GetNamedItem("v").InnerText, S = 28 });
						return group_lengths_dict[xn.Name];
					case "_42":
						pairs.Add(offset, new C { T = "FUNCTION", N = xn.Attributes.GetNamedItem("v").InnerText, S = 24});
						return group_lengths_dict[xn.Name];
					case "_43":// Mapping these to fix errors. The new length seems to fix some issues. Check pfnd > mobileNavMeshes to understand.
						...
						return group_lengths_dict[xn.Name];
					case "_44":// unmapped
						pairs.Add(offset, new C { T = "Comment", N = xn.Attributes.GetNamedItem("v").InnerText + " (unmapped type(" + xn.Name + "), may cause errors)", S = 4 });
						return group_lengths_dict[xn.Name];
					case "_45":// unmapped
						pairs.Add(offset, new C { T = "Comment", N = xn.Attributes.GetNamedItem("v").InnerText + " (unmapped type(" + xn.Name + "), may cause errors)", S = 4 });
						return group_lengths_dict[xn.Name];
